...
function B()
  menu1 = gg.multiChoice({
    ...
    "自瞄锁胸「2版」",
    "返回上一页"
  }, nil, "加速下飞机就是加速，开启后你的跳伞速度也会变快，落地关闭，距离远的别开，反馈群 794059430")
  if menu1 == nil then
  else
    if menu1[1] == true then
      b1()
...
function c60()
  ...
  gg.searchNumber("10800400", gg.TYPE_DWORD, false, gg.SIGN_EQUAL, 0, -1)
  gg.getResults(10)
  gg.editAll(" 1108004014 ", gg.TYPE_DWORD)
  gg.toast("开启成功")
  gg.searchNumber("10100300", gg.TYPE_DWORD, false, gg.SIGN_EQUAL, 0, -1)
  gg.searchNumber("10100300", gg.TYPE_DWORD, false, gg.SIGN_EQUAL, 0, -1)
  gg.getResults(10)
...
function d8()
  ...
  gg.editAll("0", gg.TYPE_FLOAT)
  gg.toast("准心聚点")
  gg.alert("成功后你就准心一直在中间了，或者丢枪再捡起来，碰和无后座超级好用！")
end
function d9()
  gg.clearResults()
  gg.setRanges(gg.REGION_ANONYMOUS)
...
function d10()
  ...
  gg.getResults(500)
  gg.editAll("0", gg.TYPE_FLOAT)
  gg.toast("S1897 子弹聚点 聚点准心开启成功")
end
function d11()
  f2 = gg.prompt({
    "温馨提示：\n推荐25(2倍效果)\n55是中间值越小倍数越大数字越大则反之如100则是缩小一半的倍数"
  }, {
    [1] = 25
  }, {
    [1] = "number"
...
function d33()
  gg.alert("锁血可能不成功，多开几次")
  gg.alert("先喝饮料，能量条在锁血就在")
  gg.clearResults()
  gg.setRanges(gg.REGION_ANONYMOUS)
...
function e1()
  gg.clearResults()
  gg.setRanges(gg.REGION_ANONYMOUS)
  gg.searchNumber("88000;4.2038953929745e-44;1.4012984643248e-44::", gg.TYPE_FLOAT, false, gg.SIGN_EQUAL, 0, -1)
...
function e2()
  gg.clearResults()
  gg.setRanges(32)
  gg.searchNumber("71500;4.2038953929745e-44;0.10000000149012::", 16, false, 536870912, 0, -1)
  gg.searchNumber("71500", 16, false, 536870912, 0, -1)
  gg.getResults(100)
  gg.editAll("700000", 16)
  gg.toast("ak")
end
function e3()
  gg.clearResults()
  gg.setRanges(32)
  gg.searchNumber("87000;4.2038953929745e-44;1.4012984643248e-44::", 16, false, 536870912, 0, -1)
  gg.getResults(10)
  gg.editAll("700000", 16)
  gg.toast("sc")
end
function e4()
  gg.clearResults()
  gg.setRanges(32)
  gg.searchNumber("99000;2.8025969286496e-44;1.4012984643248e-44::", 16, false, 536870912, 0, -1)
...
function e5()
  gg.clearResults()
  gg.setRanges(32)
  gg.searchNumber("33000;0.085600003600121::", 16, false, 536870912, 0, -1)
  gg.searchNumber("33000", 16, false, 536870912, 0, -1)
  gg.getResults(100)
  gg.editAll("600000", 16)
  gg.toast("vss")
end
function e6()
  gg.clearResults()
  gg.setRanges(32)
  gg.searchNumber("80000;1.4012984643248e-44;1.4012984643248e-44::", 16, false, 536870912, 0, -1)
...
function e7()
  gg.clearResults()
  gg.setRanges(32)
  gg.searchNumber("79000;7.0064923216241e-45;2.8025969286496e-45::", 16, false, 536870912, 0, -1)
...
function e8()
  gg.clearResults()
  gg.setRanges(32)
  gg.searchNumber("16000;0.075000002980232;0.10000000149012::", 16, false, 536870912, 0, -1)
...
function e9()
  gg.clearResults()
  gg.setRanges(32)
  gg.searchNumber("76000;7.0064923216241e-45;1.8999999761581;1.4012984643248e-45;4.2038953929745e-45::", 16, false, 536870912, 0, -1)
...
function e11()
  gg.clearResults()
  gg.setRanges(gg.REGION_BAD)
  gg.searchNumber("40000;2.5::", gg.TYPE_FLOAT, false, gg.SIGN_EQUAL, 0, -1)
...
GLWW = -1
function f15()
  gg.alert("免费脚本更新群794059430", "复制群号")
  gg.copyText("794059430")
  os.exit()
end
while true do
