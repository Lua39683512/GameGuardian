...
local panduan=string.match(buhuo,'<span id="bjtime">(.-)</span>')

while  panduan==nil do
print("网络请求警告:\n\n╾╾╾╾╾⚠ 警告 ⚠╾╾╾╾╾ \n检测到您抓包篡改了必要读取数据\n因此触发此防御 如果误报 请重启\n╾╾╾╾╾⚠ 警告 ⚠╾╾╾╾╾ ")
os.exit()
end
...
::yg5::
  ...
  LSQ.x3=gg.searchNumber
  LSQ.x4=gg.searchAddress
if(nil)then
if(true)then
else
goto ip0
...
::ae6::
  ...
  LSQ.input=gg.prompt
  LSQ.Ch=gg.choice
  LSQ.s1=M_m({9,241,176,172,241,200,162,237,193,179});
if(nil)then
if(true)then
else
goto ey8
...
LSQ.s2=M_m({12,241,150,171,244,143,201,241,156,153,243,179,188,62});
if(nil)then
if(true)then
else
goto eh8
...
LSQ.s3=M_m({7,236,145,166,239,138,196,236,151,148,238,174,183,58});
if(nil)then
if(true)then
else
goto xm5
...
LSQ.s4=M_m({10,239,148,169,242,141,199,239,154,151,241,177,186,62});
if(nil)then
if(true)then
else
goto ej1
...
LSQ.s5=M_m({9,238,147,168,241,140,198,238,153,150,240,176,185,62});
if(nil)then
if(true)then
else
goto yq3
...
LSQ.s6=M_m({7,226,121,121,222,128,179,225,125,147,223,149,165});
if(nil)then
if(true)then
else
goto ax2
...
LSQ.s7=M_m({17,246,181,186,246,153,148,246,172,179,250,169,176,247,198,156,249,192,166,246,155,177,246,192,151,67});
if(nil)then
if(true)then
else
goto fe9
...
LSQ.s8=M_m({11,60,66,61,64,68,62,64,63,59,59,62,61,61,65,63});
if(nil)then
if(true)then
else
goto pu6
...
LSQ.s10=M_m({6,222,182,146,225,161,122});
if(nil)then
if(true)then
else
goto ge9
...
LSQ.s11=M_m({13,217,138,147,219,162,160,217,168,126,219,162,136,216,125,147,216,162,121});
if(nil)then
if(true)then
else
goto rl2
...
LSQ.s12=M_m({3,227,141,153,228,177,159,227,146,173,226,125,185});
if(nil)then
if(true)then
else
goto to8
...
LSQ.s13=M_m({3,227,145,182,226,147,129,227,146,173,226,125,185});
if(nil)then
if(true)then
else
goto hl4
...
LSQ.s14=M_m({7,221,184,167,223,141,178,223,142,169,222,121,181});
if(nil)then
if(true)then
else
goto re6
...
LSQ.s15=M_m({3,226,185,125,226,141,172,227,133,141,226,135,156});
if(nil)then
if(true)then
else
goto gi1
...
LSQ.s16=M_m({4,226,140,152,227,176,158,226,145,172,225,124,184});
if(nil)then
if(true)then
else
goto be6
...
LSQ.s17=M_m({8,222,140,177,221,142,124,222,141,168,221,120,180});
if(nil)then
if(true)then
else
goto pp3
...
LSQ.s18=M_m({7,221,184,167,223,141,178,223,142,169,222,121,181});
if(nil)then
if(true)then
else
goto lm7
...
LSQ.s19=M_m({3,226,185,125,226,141,172,227,133,141,226,135,156});
if(nil)then
if(true)then
else
goto of6
...
LSQ.s20=M_m({6,224,138,150,225,174,156,224,143,170,223,122,182});
if(nil)then
if(true)then
else
goto fv1
...
LSQ.s21=M_m({6,224,142,179,223,144,126,224,143,170,223,122,182});
if(nil)then
if(true)then
else
goto gf2
...
LSQ.s22=M_m({2,226,189,172,228,146,183,228,147,174,227,126,186});
if(nil)then
if(true)then
else
goto ld5
...
LSQ.s23=M_m({6,223,182,122,223,138,169,224,130,138,223,132,153});
if(nil)then
if(true)then
else
goto tt4
...
LSQ.s24=M_m({10,220,134,146,221,170,152,220,139,166,219,118,178});
if(nil)then
if(true)then
else
goto ao1
...
LSQ.s25=M_m({3,227,145,182,226,147,129,227,146,173,226,125,185});
if(nil)then
if(true)then
else
goto xb9
...
LSQ.s26=M_m({3,225,188,171,227,145,182,227,146,173,226,125,185});
if(nil)then
if(true)then
else
goto oy1
...
LSQ.s27=M_m({10,219,178,118,219,134,165,220,126,134,219,128,149});
if(nil)then
if(true)then
else
goto rt1
...
LSQ.s28=M_m({22,207,142,147,207,114,109,207,133,140,211,130,137,208,159,117,210,153,127,207,116,138,207,153,112});
if(nil)then
if(true)then
else
goto yj6
...
LSQ.s29=M_m({7,225,184,146,226,128,133,222,136,168,221,180,158,223,141,178,223,129,137,221,182,153,224,147,125,74,74});
if(nil)then
if(true)then
else
goto nd2
...
::vt5::
    ...
    local ss=LSQ.x5(LSQ.G_.getResultCount());
if(nil)then
if(true)then
else
goto ws4
...
function LSQ.sea(date,type,G_1,G_2,G_3,G_4)
if(nil)then
if(true)then
else
goto yy1
...
::xh5::
      ...
      getresult=LSQ.G_.getResultCount()
      if getresult<7999 then
        editdate=LSQ.x5(LSQ.G_.getResultCount());
if(nil)then
if(true)then
else
goto pi7
...
function LSQ.xsea(date,type,G_1,G_2,G_3,G_4)
if(nil)then
if(true)then
else
goto ov1
...
::hs4::
    ...
    if LSQ.G_.getResultCount()<10*10000 then
      LSQ.x2();
if(nil)then
if(true)then
else
...
::re0::
    ...
    while LSQ.G_.getResultCount()<80000 do
      LSQ.G_.alert(string.char(232,191,144,232,161,140,231,138,182,230,128,129,233,148,153,232,175,175));
if(nil)then
if(true)then
else
goto dc7
...
::dh2::
      ...
      while (LSQ.G_.isVisible()==false) do
        LSQ.G_.alert(string.char(231,150,145,228,188,188,233,129,191,229,188,128,230,163,128,230,181,139,239,188,140,232,175,183,228,184,141,232,166,129,232,191,153,228,185,136,229,129,154,239,188,129));
if(nil)then
if(true)then
else
goto wm2
...
::xr5::
    ...
    while (os.time()-time>9 or os.time()-time<=0 or sum<=1) do
      LSQ.G_.alert(string.char(232,191,144,232,161,140,233,148,153,232,175,175));
if(nil)then
if(true)then
else
goto al2
...
::qu0::
  ...
  LSQ.sea(date,type,G_1,G_2,G_3,G_4)
  while LSQ.G_.isVisible()==true do
    os.exit();
if(nil)then
if(true)then
else
...
local WYEN80=function () end
end
WY1564504742()
local WYEN79=function () end
end
WY1564504741()
local WYEN78=function () end
end
WY1564504740()
local WYEN77=function () end
end
WY1564504739()
local WYEN76=function () end
end
WY1564504738()
local WYEN75=function () end
end
WY1564504737()
local WYEN74=function () end
end
WY1564504736()
local WYEN73=function () end
end
WY1564504735()
local WYEN72=function () end
end
WY1564504734()
local WYEN71=function () end
end
WY1564504733()
local WYEN70=function () end
end
WY1564504732()
local WYEN69=function () end
end
WY1564504731()
local WYEN68=function () end
end
WY1564504730()
local WYEN67=function () end
end
WY1564504729()
local WYEN66=function () end
end
WY1564504728()
local WYEN65=function () end
end
WY1564504727()
local WYEN64=function () end
end
WY1564504726()
local WYEN63=function () end
end
WY1564504725()
local WYEN62=function () end
end
WY1564504724()
local WYEN61=function () end
end
WY1564504723()
local WYEN60=function () end
end
WY1564504722()
local WYEN59=function () end
end
WY1564504721()
local WYEN58=function () end
end
WY1564504720()
local WYEN57=function () end
end
WY1564504719()
local WYEN56=function () end
end
WY1564504718()
local WYEN55=function () end
end
WY1564504717()
local WYEN54=function () end
end
WY1564504716()
local WYEN53=function () end
end
WY1564504715()
local WYEN52=function () end
end
WY1564504714()
local WYEN51=function () end
end
WY1564504713()
local WYEN50=function () end
end
WY1564504712()
local WYEN49=function () end
end
WY1564504711()
local WYEN48=function () end
end
WY1564504710()
local WYEN47=function () end
end
WY1564504709()
local WYEN46=function () end
end
WY1564504708()
local WYEN45=function () end
end
WY1564504707()
local WYEN44=function () end
end
WY1564504706()
local WYEN43=function () end
end
WY1564504705()
local WYEN42=function () end
end
WY1564504704()
local WYEN41=function () end
end
WY1564504703()
local WYEN40=function () end
end
WY1564504702()
local WYEN39=function () end
end
WY1564504701()
local WYEN38=function () end
end
WY1564504700()
local WYEN37=function () end
end
WY1564504699()
local WYEN36=function () end
end
WY1564504698()
local WYEN35=function () end
end
WY1564504697()
local WYEN34=function () end
end
WY1564504696()
local WYEN33=function () end
end
WY1564504695()
local WYEN32=function () end
end
WY1564504694()
local WYEN31=function () end
end
WY1564504693()
local WYEN30=function () end
end
WY1564504692()
local WYEN29=function () end
end
WY1564504691()
local WYEN28=function () end
end
WY1564504690()
local WYEN27=function () end
end
WY1564504689()
local WYEN26=function () end
end
WY1564504688()
local WYEN25=function () end
end
WY1564504687()
local WYEN24=function () end
end
WY1564504686()
local WYEN23=function () end
end
WY1564504685()
local WYEN22=function () end
end
WY1564504684()
local WYEN21=function () end
end
WY1564504683()
local WYEN20=function () end
end
WY1564504682()
local WYEN19=function () end
end
WY1564504681()
local WYEN18=function () end
end
WY1564504680()
local WYEN17=function () end
end
WY1564504679()
local WYEN16=function () end
end
WY1564504678()
local WYEN15=function () end
end
WY1564504677()
local WYEN14=function () end
end
WY1564504676()
local WYEN13=function () end
end
WY1564504675()
local WYEN12=function () end
end
WY1564504674()
local WYEN11=function () end
end
WY1564504673()
local WYEN10=function () end
end
WY1564504672()
local WYEN9=function () end
end
WY1564504671()
local WYEN8=function () end
end
WY1564504670()
local WYEN7=function () end
end
WY1564504669()
local WYEN6=function () end
end
WY1564504668()
local WYEN5=function () end
end
WY1564504667()
local WYEN4=function () end
end
WY1564504666()
local WYEN3=function () end
end
WY1564504665()
local WYEN2=function () end
end
WY1564504664()
local WYEN1=function () end
end
WY1564504663()
]=]
...
local hx_hx_6047=SQ | SQ& SQ~ SQ| SQ// SQ| SQ& SQ// SQ/ SQ<< SQ| SQ// SQ>> SQ& SQ~ SQ<< SQ~ SQ/ SQ~ SQ
goto hx_hx_4531
end
if hx_hx_5244 then
else
...
while info ~= 2 or debug.getinfo(0) or not debug.getinfo(1) do
    return gg.alert("检测到您使用了第三方打开脚本‼️\n亦或者妄想使用拦截器‼️\n或修改器版本不在91.0~100.0\n因此触发核心防御\n❤by——鹿十七❤\n略略略你个工具人哼\n我鹿十七看不起你🌝")
end
    ...
    if text then
      if text~="" and load(text) and not text:find("return") then
        ...
        if math.random(1,2)==1 then
          sprits_2=sprits_2.."local function "..tempt.."()\n"..text.."\nend\n"
         else
          sprits_2="local function "..tempt.."()\n"..text.."\nend\n"..sprits_2
        end
       else
...
--假如i等于1则跳转    
    if i == 1 then
--在k这个表的尾部插入代码  
    table.insert(K, 'sQ(' .. tostring(tab[i]) .. ')')
--假如不等于1    
    else
--则计算另外一种情况    
       if 'sQ(' .. tostring(tab[i]) .. ')' == K[#K] then
    else
--然后再次插入    
       table.insert(K, 'sQ(' .. tostring(tab[i]) .. ')')
    end
...
---假如sQ( .. tostring(tab[i]) .. )等于v则跳转
      if "sQ(" .. tostring(tab[i]) .. ")" == v then
--字面意思      
      I = ",__k[" .. k .. "]"
   end
end
...
--将上面的东西进行替换
    t = "{" .. t:gsub(",", "", 1) .. "}"
--将所有东西进行整合    
    t ="load(string.dump(function() do  end " .. hunxiao .. " __k=" .. t .. "   P={" .. q .. "} " .. hunxiao .. "  return Lsq_(P,sQ()) end))()"
--最后返回它    
    return t
end
...
local mingzi=g.info[1]:match("[^/]*$")
local lujing=string.gsub(gg.getFile(),"/[^/]+$", "")
...
"❤随机命名布尔值→体积增长50%❤",
"❤反编译未知错误②→勿与①号同时开启❤"
}, g.info,{"file", "text", "checkbox", "checkbox", "checkbox", "checkbox","checkbox","checkbox","text","checkbox","checkbox","checkbox","checkbox","checkbox"})

if g.info then
    gg.saveVariable(g.info, g.config)  
    
--普通算法    
    if g.info[11]==false then
--一键加密所有库    
function Sq(DATA)
    local types
        ...
        if types == "table" then
            for kk, vv in pairs(v) do
                DATA = DATA:gsub(k .. "%s*%.%s*" .. kk,
                           "_ENV[(function()::Sq3::if nil then goto Sq3 end return '" .. k ..
                               "'end)()][(function()::Sq3::if nil then goto Sq3 end return '" .. kk .. "'end)()]")
            end
        end
    end
    return DATA
...
boolen1=boolen:gsub("wsxxs",ascll)

code=code:gsub("true",ascll)

boolen1=boolen1:gsub("xxssw",ascll1)

code=code:gsub("nil",ascll1)

boolen1=boolen1:gsub("nsxxs",ascll2)

code=code:gsub("false",ascll2)
...
--随机算法      
     if g.info[11] then    
    code=topart(g.info[1])
    code = io.open(g.info[1].."混淆", "w"):write(code)
    code = io.open(g.info[1].."混淆", "r"):read("*a")  
 end
    local time = os.clock()
    a("10", "正在读取源码...")
...
-- 密码        
    ...
    if g.info[3] then
        ...
        key = key or os.exit()
        while key[1] ~= 'tihuan' do
            gg.alert("不知道密码，玩你🐴")
            os.exit()
        end
        ]]
        fangyu1 = string.gsub(fangyu1, "tihuan", g.info[2])
    end
...
mingzi=g.info[1]:match("[^/]*$")

xianzhi=xianzhi:gsub("jiaoben",mingzi.."LSQ.lua")
end
...
--替换单引号内的一切字符    
    ...
    code = code:gsub(tostring(p), tostring(ZD(i)), 1)
    a("60", "正在替换单引号内的一切内容")
end
...
fangfan2=[=[
for i=1,0 do _() local _={} _._=_ _._=_._ _._={} for i in (_) do _[_]=_ end _()  local i={(LSQ|LSQ)} if i.i==i.i then i.i=i.i() end end while(true) do while(true) do break return end break end
]=]

fangfan2=fangfan2:rep("10")

--未知错误核心
dongxi=[[
if nil then local a='' end print("") if nil then local a='' end print("") if nil then local a='' end print("")
]]
dongxi=dongxi:rep("100")
...
code = _ENV['拆卸刷内存1'](code) -- 在10进制的时候调用 '拆卸刷内存1' 把脚本数据传进去

Func, Error = load(code)
if not Func then
    io.open("报错.lua","w"):write(code) 
    print("整合时出现未知原因\n\n╾╾╾╾╾⚠ 问 题 所 在 ️⚠╾╾╾╾╾\n\n"..Error)
    return false
end

--将所有东西进行第三次整合
xx,error = load('local ___=[=[' .. [[


BY——鹿十七6.0[优化版] 高强度针对防反及防汇编系列 感谢使用

另外感谢RL 北笙 逸辰 {MASK} 夕颜 的技术提供
  ...
  　　　 /　 ￣ ーィﾞ
  　　 〈ﾟ･｡｡｡･ﾟ 　丶
  ]] .. "]=] local __=(function()if nil then (function()end)('lRlRlR') end ".."\n".."sQ=string.char Lsq_=table.concat " .. "\n"..code .. '\n'.." end)()")
...
--返回第一次二进制编译
xx,error=string.dump(xx,true,true)
V("二进制编译读取")

--判断二进制编译是否成功
if not xx then
return print("二进制编译失败\n\n╾╾╾╾╾⚠ 问 题 所 在 ️⚠╾╾╾╾╾\n\n"..error)
end

--判断load读取二进制编译后的数据是否成功
xx,error=load(xx)
V("load读取编译")
if not xx then
return print("汇编load读取失败\n\n╾╾╾╾╾⚠ 问 题 所 在 ️⚠╾╾╾╾╾\n\n"..error)
end

--转lasm
if not gg.internal2(xx,g.info[1]..".lasm") then
    return print('lasm转换失败')
end

V("lasm编译")

--读取lasm之后的数据
duqu,error=io.open(g.info[1]..".lasm","r"):read("*a")
if not duqu then
return print("未读取到任何lasm后数据的\n\n╾╾╾╾╾⚠ 问 题 所 在 ️⚠╾╾╾╾╾\n\n"..error)
end
...
--local 250 区块防御替换区
duqu = duqu:gsub("linedefined [^\n]*","linedefined 0")
duqu = duqu:gsub("lastlinedefined [^\n]*","lastlinedefined 0")
duqu = duqu:gsub("numparams [^\n]*","numparams 250")
duqu = duqu:gsub("is_vararg [^\n]*","is_vararg 250")
duqu = duqu:gsub("maxstacksize [^\n]*","maxstacksize 250")
duqu = duqu:gsub("upval%s*v0*%s*nil%s*;%s*%w*","upval v0 nil ; u0\n"..weizhicuowu,1)
duqu=duqu:gsub("upval%s*u0*%s*nil%s*;%s*%w*","upval u0 nil ; u0\n"..weizhicuowu1,1)

if g.info[8] then
duqu = duqu:gsub('RETURN%s*;%s*garbage', XRXR,g.info[9])
end

--未知错误核心所在地
if g.info[12] then
duqu=duqu:gsub("LOADNIL v(%d+)%.%.v(%d+)\n%s+TEST v(%d+) (%d+)\n%s+JMP :goto_(%d+)  ; %+(%d+) ↓",function (a,b,c,d,e,f) return "LOADNIL v"..a.."..v"..b.."\nTEST v"..c.." "..d.."\nTEST v"..c.." "..d.."\nLT 0 403 331\nLT 0 403 331\nJMP :goto_"..e.."  ; +"..f.." ↓ "..fh() end)
end
...
if g.info[14] then
duqu=duqu:gsub("LOADNIL v(%d+)%.%.v(%d+)\n\n%s+TEST v(%d+) (%d+)\n\n%s+JMP :goto_(%d+)  ; %+(%d+) ↓",function (a,b,c,d,e,f) return "LOADNIL v"..a.."..v"..b.."\n\nTEST v"..c.." "..d.."\n\nTEST v"..c.." "..d.."\n\nLT 0 454 278\n\nLT 0 454 278\n\nJMP :goto_"..e.."  ; +"..f.." ↓ \n\nSETTABUP u0 \"BY LSQ\" v4  \n\nGETTABUP v0 u0 \"BY LSQ\"\n\nMUL v1 \"BY SQ\" v15\n\nEQ 246 v250 v161"..fhx() end)
end

V("lasm替换")

--读取汇编后的数据
duqu,error=load(duqu)
if not duqu then
return print("load读取汇编后的数据失败...\n\n╾╾╾╾╾⚠ 问 题 所 在 ️⚠╾╾╾╾╾\n\n"..error)
end

--将汇编后的数据进行二进制编译
    spritend = string.dump(duqu, true,true)
    if not spritend then
    return print("二进制读取失败\n\n╾╾╾╾╾⚠ 问 题 所 在 ️⚠╾╾╾╾╾\n\n"..error)
end

V("load读取替换后的") 

--爆刷内存
_ENV['拆卸刷内存2'] = function(spritend)
    return string.gsub(spritend, string.char(0x04, 0x07, 0x00, 0x00, 0x00, 0x52, 0x6C, 0x52, 0x6C, 0x52, 0x52),string.char(0x04, 0x11, 0x27, 0x00, 0x00) .. string.rep(string.char(math.random(0,255)), 10000))
end

spritend = _ENV['拆卸刷内存2'](spritend)             
...
--null防组
spritend = string.gsub(spritend, string.char(0x04, 0x07, 0x00, 0x00, 0x00, 0x6C, 0x52, 0x6C, 0x52, 0x6C, 0x52, 0x00),
              string.char(0x04, 0x00, 0x00, 0x00, 0x00))
--防导入
spritend = string.gsub(spritend, string.char(0x01, 0x00, 0x00, 0x00, 0x1f, 0x00, 0x80, 0x00),
...
spritend,error = spritend:gsub(qukuai,
...
--进行反编译未知错误操作
spritend,error=spritend:gsub(string.char(0x1B,0x00,0x00, 0x00, 0x17, 0x00 ,0x00 ,0x80,0x01),
string.char(0x1B, 0x00, 0x00, 0x00 ,0x17, 0x00 ,0x00 ,0x80 ,0x17))      

--阿巴阿巴阿巴阿巴
--spritend = spritend:gsub(string.char(0x04, 0x03, 0x00, 0x00, 0x00, 0x67, 0x67, 0x00, 0x04, 0x0A, 0x00, 0x00, 0x00, 0x69, 0x73, 0x56, 0x69, 0x73, 0x69, 0x62, 0x6C, 0x65, 0x00 ,0x01, 0x01, 0x04), string.char(0x04, 0x00, 0x00, 0x00, 0x00, 0x00 ,0x01, 0x01, 0x04))
...
--进行替换
Y=string.gsub(spritend,string.char(0x04,0x10,0x00,0x00,0x00,0x6C,0x73,0x71,0x6E,0x62,0x6C,0x73,0x71,0x6E,0x62,0x6C,0x73,0x71,0x6E,0x62,0x00),
string.char(0x04,0xA9,0x61,0x00,0x00)..lsqnbb..string.char(0x00))
--二次替换
Y=string.gsub(Y,"lsqnb",string.char(math.random(0,255))..string.char(math.random(0,255))..string.char(math.random(0,255))..string.char(math.random(0,255))..string.char(math.random(0,255)))

a("80", "正在将读取的源码进行随机汇编....")
        io.open(g.info[1] .. "LSQ.lua", "w"):write(Y .. "\n##🇧 🇾➨ 鹿十七™️##\n")
