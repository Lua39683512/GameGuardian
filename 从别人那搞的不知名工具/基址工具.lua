...
-- [[  gg.loadResults(old)    if iii ~= 0 then        print("请打开运算软件<hello_gg> | \n运算出的路径为 : "..p[3])    end    break
end       
file_l:close()
...
local SN = gg.choice({ --项目选项[[{
    ...
    if SN == 1 then Search_the_base_addressA()
    elseif SN == 2 then Search_the_base_addressB() 
    elseif SN == 3 then Search_the_base_addressC() 
    elseif SN == 4 then The_text_contrasts() 
    elseif SN == 5 then Base_address_Blind_to() 
    elseif SN == 6 then Base_address_filtering() 
    elseif SN == 7 then os.exit()
    end
