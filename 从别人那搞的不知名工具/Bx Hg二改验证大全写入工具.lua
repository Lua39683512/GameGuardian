...
function Bxin()
  BxA=gg.prompt(
  {'验证写入工具 北玄201902409 豪哥QQ2929038544 群709606679'},
...
function BxI()
  ...
  BxCd:write(BxCg)
  BxCd:close()
  BxCf = "Bx = gg.prompt({     '支持时间[北玄:1@7@30豪哥:3650@999999]','输入机器码'   }, {      [1]='',   [2]=''      }, {'text','tex'})       if Bx == nil then    gg.alert('再见.结束成功! ') os.exit()     end           Bxz=Bx[1]*Bx[2]+"..BxCa[1].."      print(Bxz)"
